...
static unsigned char header_bytes[] = {
    ...
    // HEIGHT (patched at runtime)
    0x00,0x40,      // placeholder

    // WIDTH (patched at runtime)
    0x00,0x40,      // placeholder
...
SC_MODULE(HeaderGen) {
    ...
    // Kick header generation
    sc_in<bool> start;

    // Output to bitstream FIFO
